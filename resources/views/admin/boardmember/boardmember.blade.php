                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Create Board Member</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <form action="{{ route('boardmember.store') }}" method="post">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="communittee_name" id="InputCommunitteeName" class="form-control">
                                                <option value="" disabled selected>Select Communitee Name</option>
                                                @foreach ($communittes as $communittee)
                                                    <option value="{{ $communittee->id }}">{{ $communittee->name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="communittee_position" id="InputCommunitteePosition" class="form-control">
                                                <option value="" disabled selected>Select Communitee Position</option>
                                                <option value="Head">Head Of Communittee</option>
                                                <option value="Vice Head">Vice Head Of Communittee</option>
                                                <option value="--">--</option>
                                            </select>
