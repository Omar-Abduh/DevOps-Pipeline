                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('boardmember.index') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>View Board Members</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('boardmember.create') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('communities.index') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>View Communities</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('communities.create') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Create Communittee</p>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('announcement.view') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
