                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-header">
                                <h3 class="card-title">Update Majors Data</h3>
                            </div>
                            ...
                            <form action="{{ route('major.update') }}" method="post">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" id="InputMajor"
                                            placeholder="Enter Major" value="{{ old('name', $major->name) }}">
                                    </div>
                                    @error('name')
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary">Update Major Data</button>
                                </div>
                            </form>
                        </div>
