                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="academic_year_id" id="InputAcademicYear" class="form-control">
                                                ...
                                                @foreach ($academic_years as $academic_year)
                                                    <option value="{{ $academic_year->id }}" {{ $academic_year->id == $student->academic_year_id ? 'selected' : '' }}>{{ $academic_year->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="date" name="admission_date" id="InputAdmissionDate"
                                                class="form-control" value="{{ old('admission_date', $student->admission_date) }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="sut_id" class="form-control" id="InputSutId"
                                                placeholder="Enter SUT ID" value="{{ old('sut_id', $student->sut_id) }}">
                                            @error('sut_id')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="date" name="dob" class="form-control" id="InputDoB" value="{{ old('dob', $student->dob) }}">
