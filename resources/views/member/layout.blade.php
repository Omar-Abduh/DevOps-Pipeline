        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
                <span class="brand-text font-weight-light">{{ Auth::guard('member')->user()->name }}</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('member.dell-event-attendance.data') }}" class="nav-link">
                        ...
                        {{-- <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('sut-student.index') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>View SUT Students Data</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('sut-student.create') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add SUT Student Data</p>
                                    </a>
                                </li>
                            </ul>
                        </li> --}}
